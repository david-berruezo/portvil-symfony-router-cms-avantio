...
class DynamicGeoregionType extends AbstractType implements DataMapperInterface
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('dynamicGeoregion')
            //->add('dynamicGeolocality')
            ->add('textTitle')
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class'      => DynamicGeoregion::class,
