...
use App\Repository\DynamicTaxonomyGroupRepository;
 ...
 *
 */
#[ORM\Table(name: 'dynamic_taxonomy_group')]
#[ORM\Entity(repositoryClass: DynamicTaxonomyGroupRepository::class)]
class DynamicTaxonomyGroup
{
    /**
     * @var int
     *
    ...
    #[ORM\Column(name: 'dynamic_taxonomy_group', type: 'integer', nullable: false)]
    private ?int $dynamicTaxonomyGroup;
    ...
    public function getDynamicTaxonomyGroup(): ?int
    {
        return $this->dynamicTaxonomyGroup;
    }

    public function setDynamicTaxonomyGroup(?int $dynamicTaxonomyGroup): void
    {
