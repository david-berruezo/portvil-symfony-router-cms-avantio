...
use App\Repository\DynamicGeodistrictRepository;
...
#[ORM\Entity(repositoryClass: DynamicGeodistrictRepository::class)]
class DynamicGeodistrict
{
    ...
    #[ORM\ManyToOne(targetEntity: DynamicGeolocality::class, inversedBy: 'dynamicGeodistrict')]
    #[ORM\JoinColumn(name: 'dynamic_geolocality', referencedColumnName: 'id')]
    private ?DynamicGeolocality $dynamicGeolocality=null;
     ...
     *
     */
    #[ORM\Column(name: 'text_postalcode', type: 'string', length: 5, nullable: true, options: ['fixed' => true, 'comment' => 'Código Postal'])]
    private $textPostalcode="";
     ...
     * @return string|null
     */
    public function getTextPostalcode(): ?string
    {
        return $this->textPostalcode;
    }

    /**
     * @param string|null $textPostalcode
     */
    public function setTextPostalcode(?string $textPostalcode): void
    {
        $this->textPostalcode = $textPostalcode;
    }

    /**
     * @return int|null
     */
    public function getDynamicGeodistrict(): ?int
    {
        return $this->dynamicGeodistrict;
    }

    /**
     * @param int|null $dynamicGeodistrict
     */
    public function setDynamicGeodistrict(?int $dynamicGeodistrict): void
    {
        $this->dynamicGeodistrict = $dynamicGeodistrict;
    }

    /**
     * @return DynamicGeolocality|null
     */
    ...
    /**
     * @param DynamicGeolocality|null $dynamicGeolocality
     */
